...
#define gthreadArrayAdd(                ARRAY,        VALUE)                                                      g_ArrayAdd(                (G_Array *) ARRAY,        (Gp *) VALUE) 
#define gthreadArrayAddAt(              ARRAY, INDEX, VALUE)                                                      g_ArrayAddAt(              (G_Array *) ARRAY, INDEX, (Gp *) VALUE) 
#define gthreadArrayAddBegin(           ARRAY,        VALUE)                                                      g_ArrayAddBegin(           (G_Array *) ARRAY,        (Gp *) VALUE) 
#define gthreadArrayAddEnd(             ARRAY,        VALUE)                                                      g_ArrayAddEnd(             (G_Array *) ARRAY,        (Gp *) VALUE) 
...
#define gthreadArrayErase(              ARRAY, VALUE)                                                             g_ArrayErase(              (G_Array *) ARRAY, (Gp *) VALUE) 
...
#define gthreadArrayFind(               ARRAY, VALUE)                                                             g_ArrayFind(               (G_Array *) ARRAY, (Gp *) VALUE) 
#define gthreadArrayFlush(              ARRAY)                                                                    g_ArrayFlush(              (G_Array *) ARRAY) 
#define gthreadArrayForEach(            ARRAY, FUNC)                                                              g_ArrayForEach(            (G_Array *) ARRAY, FUNC) 
#define gthreadArrayGet(                ARRAY)                                             (Gthread **)           g_ArrayGet(                (G_Array *) ARRAY) 
#define gthreadArrayGetAt(              ARRAY, INDEX)                                    *((Gthread **)           g_ArrayGetAt(              (G_Array *) ARRAY, INDEX))
#define gthreadArrayGetBegin(           ARRAY)                                           *((Gthread **)           g_ArrayGetBegin(           (G_Array *) ARRAY))
#define gthreadArrayGetCount(           ARRAY)                                                                    g_ArrayGetCount(           (G_Array *) ARRAY) 
#define gthreadArrayGetEnd(             ARRAY)                                           *((Gthread **)           g_ArrayGetEnd(             (G_Array *) ARRAY))
...
#define gthreadArrayUpdateAt(           ARRAY, INDEX, VALUE)                                                      g_ArrayUpdateAt(           (G_Array *) ARRAY, INDEX, (Gp *) VALUE) 
