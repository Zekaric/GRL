...
#define gsKeyTableCloc(                     HASHSIZE)             (GsKeyTable *)   g_HashCloc(                                "GsKeyTable", GsKey *, gbTRUE, (GrlCompareFunc) gsCompare, (GrlHashFunc) gsHash, HASHSIZE)
#define gsKeyTableClocContent(   KEY_TABLE, HASHSIZE)                              g_HashClocContent(   (G_Hash *) KEY_TABLE, "GsKeyTable", GsKey *, gbTRUE, (GrlCompareFunc) gsCompare, (GrlHashFunc) gsHash, HASHSIZE)
#define gsKeyTableDloc(          KEY_TABLE)                                        g_HashDloc(          (G_Hash *) KEY_TABLE)
#define gsKeyTableDlocContent(   KEY_TABLE)                                        g_HashDlocContent(   (G_Hash *) KEY_TABLE)
